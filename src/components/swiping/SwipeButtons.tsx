  ...
  return (
    <div className="flex items-center justify-evenly w-full max-w-sm py-6 px-4 z-10">
      ...
      <Button
        onClick={openDetails}
        variant="outline"
        className="h-16 w-16 rounded-full shadow-md text-base font-semibold border-neutral-600/80 bg-neutral-800/30 text-neutral-300 hover:bg-neutral-700/50 flex items-center justify-center backdrop-blur-sm"
